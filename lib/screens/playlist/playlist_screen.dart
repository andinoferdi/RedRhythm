...
class _PlaylistScreenState extends ConsumerState<PlaylistScreen> {
  ...
  void _toggleShuffle() {
    ...
    // Only allow shuffle toggle if no music is playing OR playing from this playlist
    if (!playerState.isPlaying || playerState.currentPlaylistId == _currentPlaylist.id) {
          ...
          child: Row(
            children: [
              ...
              IconButton(
                onPressed: () {
                  final playerState = ref.read(playerControllerProvider);
                  // Only enable if no music is playing OR playing from this playlist
                  if (!playerState.isPlaying || playerState.currentPlaylistId == _currentPlaylist.id) {
                    _toggleShuffle();
                  }
                },
                icon: Icon(
                  ...
                  color: () {
                    ...
                    final canShuffle = !playerState.isPlaying || playerState.currentPlaylistId == _currentPlaylist.id;
